    ...
    >
      <div
        className={`md:block flex ${
          selectedTab === 1 ? "justify-between" : "justify-center items-center"
      ...
      >
        ...
        {selectedTab === 1 && (
          <button
            className={
              "md:hidden flex bg-primary p-4 uppercase font-semibold text-xs sm:text-lg md:text-xl lg:text-[22px]"
            }
          >
            Contact Sales
          </button>
